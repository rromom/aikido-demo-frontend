...
| 4 | XSS almacenado: comentarios renderizados con `v-html` | [src/views/ProductDetail.vue:26](src/views/ProductDetail.vue#L26) | A03:2021 Injection | SAST / DAST |
...
| 10 | Consumo del IDOR de `GET /orders?buyer_id=` (el backend no valida que el id pertenezca al llamante) | [src/views/MyOrders.vue:42](src/views/MyOrders.vue#L42) | A01:2021 Broken Access Control | SAST / DAST |
